        ...
        <section>
            <div className='md:pt-32 pt-28 pb-12'>
                <div className='container'>
                    ...
                    <div className="relative lg:pb-24 md:pb-16 pb-0 before:bg-[url('../../public/contact-us/message.png')] before:absolute before:bg-no-repeat before:bg-cover before:bg-center before:w-[334px] before:h-[182px] before:lg:right-48 md:before:right-28 md:before:block before:hidden">
                        <CTA
                            text="SEND MESSAGE"
