        ...
        <div className="md:pt-32 pt-28 pb-12 bg-[url('../../public/instagram-marketing/hero.png')] bg-center bg-no-repeat bg-cover">
            <div className="container">
                <div className="text-center text-white">
                    <h4 className="md:text-2xl text-xl font-normal font-berlin">LeadzExperts</h4>
                    <h3 className="mb-2 md:text-2xl text-xl font-normal font-berlin">Get Ready to Become the Talk of the Town with Our</h3>
                    <h1 className="mb-2 font-berlin font-extrabold lg:text-[50px] lg:leading-[60px] text-4xl">Instagram Marketing Services!</h1>
                    <p className="text-sm leading-7 lg:px-12 font-normal">Leads running dry? Do you know why? Because you haven't yet accessed the untapped and unprecedented marketing opportunities, Instagram offers you! From helping you engage with
